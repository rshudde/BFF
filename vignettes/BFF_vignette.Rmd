...
z.test.BFF(z_stat = z_score_one, n = 100, save = FALSE) #one sample z-test
...
z.test.BFF(z_stat = z_score_one, n = 100, save = FALSE, savename = "z-BFF-one.pdf") #one sample z-test
...
z.test.BFF(z_stat = z_score_one, n = 100, save = FALSE, xlab = "RMSE", ylab = "Logarithm of Bayes Factor", main = "BFF curves") #one sample z-test
